...
from heart.entities.models import (LogregConfig, RFConfig)
from heart.entities.config import (SplittingConfig, FeatureConfig, DatasetConfig)
...
@pytest.fixture(scope='session')
def dataset_config_v1(dataset_path: str) -> DatasetConfig:
